# Generated by Django 5.0.1 on 2024-01-15 12:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plate_number', models.CharField(blank=True, max_length=10, null=True, unique=True, verbose_name='Plate Number')),
                ('bus_series', models.CharField(choices=[('1', 'Queltehue'), ('2', 'Tricahue'), ('3', 'Retrofit')], max_length=10, verbose_name='Serie')),
                ...
                ('lts_odometer', models.FloatField(blank=True, default=None, null=True, verbose_name='LTS Odometer')),
                ('lts_isolation', models.FloatField(blank=True, default=None, null=True, verbose_name='LTS Isolation')),
                ('lts_24_volt', models.FloatField(blank=True, default=None, null=True, verbose_name='LTS 24 Volt')),
                ('lts_fusi', models.FloatField(blank=True, default=None, null=True, verbose_name='LTS FUSI')),
                ('lts_update', models.DateTimeField(auto_now=True, null=True, verbose_name='LTS Update')),
            ],
            options={
                'verbose_name': 'Bus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fusi_level', models.CharField(max_length=5, verbose_name='Fusi Level')),
                ('fusi_serie', models.CharField(blank=True, max_length=10, null=True, verbose_name='Fusi Serie')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('TimeStamp', models.DateTimeField(blank=True, null=True, verbose_name='TimeStamp')),
                ('jarvis_version_mayor', models.CharField(max_length=5, verbose_name='Mayor')),
                ('jarvis_version_minor', models.CharField(max_length=5, verbose_name='Minor')),
                ('jarvis_version_patch', models.CharField(max_length=5, verbose_name='Patch')),
                ('bus', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bus_signals.bus')),
            ],
            options={
            ...
            managers=[
                ('jarvis_version', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='LenzeCurrent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('TimeStamp', models.DateTimeField(blank=True, null=True, verbose_name='TimeStamp')),
                ('mark_version_mayor', models.CharField(max_length=5, verbose_name='Mayor')),
                ('mark_version_minor', models.CharField(max_length=5, verbose_name='Minor')),
                ('mark_version_patch', models.CharField(max_length=5, verbose_name='Patch')),
                ('bus', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bus_signals.bus')),
            ],
            options={
            ...
            managers=[
                ('mark_version', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
