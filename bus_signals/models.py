...
class Bus(models.Model):
    bus_name = models.CharField('Name', max_length=40, unique=True, blank=False, null=False, db_index=True)
    sniffer = models.CharField('Sniffer', max_length=10, unique=True, blank=False, null=False, db_index=True)
    plate_number = models.CharField('Plate Number', max_length=10, unique=False, blank=True, null=True, db_index=True)
    bus_series = models.CharField('Serie', max_length=100, choices=series_choices, blank=False, null=False, db_index=True)
    client = models.CharField('Client', max_length=20, blank=False, null=False, default='Link', db_index=True)
    lts_soc = models.IntegerField('LTS SOC', default=None, blank=True, null=True, db_index=True)
    lts_odometer = models.IntegerField('LTS Odometer', default=0, blank=True, null=True, db_index=True)
    ...
    jarvis = models.CharField('Jarvis', max_length=20, blank=True, null=True, default='1.0.0', db_index=True)
    vision = models.CharField('Vision', max_length=20, blank=True, null=True, default='1.0.0', db_index=True)
    bus_img = models.ImageField(null=True, blank=True, default='bus.png', db_index=True)
    bus_ecu = models.CharField('Bus ECU', max_length=20, blank=True, null=True, choices=message_class_choices, db_index=True)
    soh = models.IntegerField('SOH', blank=True, null=True, db_index=True)
    bus_type = models.CharField('Type', max_length=20, blank=True, null=True, db_index=True)
    key_state = models.ImageField('Key State', null=True, blank=True, db_index=True)
    ecu_state = models.IntegerField('ECU State', blank=True, null=True, db_index=True)
